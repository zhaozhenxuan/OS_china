...
public class RemenDT_Fragment extends BaseFragment {
    ...
    public int getLayoutId() {
        return R.layout.trends_remendt_item;
    }

    @Override
    public void initView(View view) {
        trends_newsdt__listview = (ListView) getActivity().findViewById(R.id.trends_remendt__listview);
        frameLayout = (PtrFrameLayout) getActivity().findViewById(R.id.remen_ptr);
    }
    ...
    public void loderData() {
        st = page + "";
        iDt.RemenDT(st, new MyCallBack() {
            @Override
            public void onSuccess(String result) {

                Log.e("SSS","热门动弹:"+result);
